package com.lxft.dmuzychuk.entity;
...
public class Movie {
    ...
    public Movie(int id, String nameRussian, String nameNative, int yearOfRelease, double rating, double price, String picturePath) {
        this.id = id;
